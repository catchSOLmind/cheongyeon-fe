...
export default function EraserPage() {
  ...
  return (
    <div className="h-dvh bg-white flex flex-col overflow-hidden">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="rounded-xl border border-gray-300 overflow-hidden">
              <div className="bg-primary-50 pt-3 pb-2 flex flex-col items-center">
                <img src={ImgTime} className="mt-2 w-20 h-20" />
            ...
            <div className="rounded-xl border border-gray-300 overflow-hidden">
              <div className="bg-primary-50 pt-3 pb-2 flex flex-col items-center">
                <img src={ImgPoint} className="mt-2 w-20 h-20" />
                <p className="mt-2 text-label-l text-primary-800 text-center">
                  청연 지우개 포인트
                </p>
              </div>
      ...
      {/* 추천업무 리스트 - 스크롤 가능*/}
      <div className="flex-1 overflow-y-auto px-6 mt-3 pb-6 overscroll-contain">
        {loading ? (
      ...
      {/* 하단 버튼 고정 */}
      <div className="flex-shrink-0 bg-white px-6 pb-6 pt-3">
